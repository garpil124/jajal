...
# Perintah untuk shell
@app.on_message(filters.command("sh") & filters.user(OWNER_ID) & ~filters.forwarded & ~filters.via_bot)
@app.on_edited_message(filters.command("sh") & filters.user(OWNER_ID) & ~filters.forwarded & ~filters.via_bot)
...
@app.on_message(filters.command("link") & filters.user(OWNER_ID) & ~filters.forwarded & ~filters.via_bot)
